<template>
  <div class="user-orders" v-if="activeOrders.length > 0">
    <div class="order-nav">
      <div class="nav-box">
        <div v-for="order in activeOrders" :key="order.pk" @click="selectedOrder = order" :class="{ 'active-order': selectedOrder.pk == order.pk }">
    ...
    <div class="order-content">
          ...
          <div class="description">
            ...
            <div class="column">
              <div class="price">
                ...
                <div class="value">{{totalPrice(selectedOrder.order)}}&#x20bd;</div>
              ...
              <div class="price">
                <div class="">
                  <dub-button @click.native="addToCart(selectedOrder)">повторить заказ</dub-button>
              </div>
                <div class="">
                  <dub-button type="secondary">сохранить как шаблон</dub-button>
              </div>
        ...
        <div class="cart">
          ...
          <div v-for="product in selectedOrder.order" :key="product.price.pk" class="item">
